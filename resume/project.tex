...
\cventry
    {Tech: \quad Rust, Go, Polkadot, Substrate, Ethereum, Solidity, Cryptography, LevelDB, Oracle, Docker}
    {ChainSafe Systems - Sygma(ChainBridge)}
    {}
    {Feb. 2022 - Mar. 2025}
    {
      \begin{cvitems}
        ...
        \item {Designed and developed the Sygma Substrate pallets along with mainnet, testnet, local testnet runtime.}
        \item {Designed and developed the independent pallets with XCM to support Sygma on any substrate based chain(parachain and parathread).}
        \item {Integrated with Phala mainet on Polkadot, testnet on Kusama.}
        \item {Integrating with Asset hub and bridge hub parachian(WIP)}
        \item {Designed the feature upgrade process for local testnet, public testnet, mainnet with docker images.}
        \item {Cross organization collabration with Phala team in a different time zone.}
...
\cventry
    {Tech: \quad Go, Cosmos-SDK, Chainlink}
...
\cventry
    {Tech: \quad Go, NodeJS, Redis, PostgreSQL, Bloom Filter, HD wallet, FSM, Ethereum, BitCoin, Solana}
...
\cventry
    {Tech: \quad Go, Tendermint, PBFT, Cosmos-SDK}
...
\cventry
    {Tech: \quad BitCoin, Ethereum, Typescript, BIP-32, BIP-39, Ed25519, Secp256K1, RIPEMD160, SHA256}
